...
<Steps>
  <Step title="Configure for ASP.NET Core">
  ...
  <Step title="Configure for Console Applications">
...
<Tabs>
  ...
  <Tab title="With Feature Flags">
    Use feature flags to control provider selection:
...
<Tabs>
  ...
  <Tab title="Assembly Scanning">
    ...
    **Best for**: Large projects with many handlers.
  </Tab>

  <Tab title="Conditional Registration">
