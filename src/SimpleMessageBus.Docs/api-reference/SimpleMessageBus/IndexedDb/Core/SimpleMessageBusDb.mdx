...
keywords: ['SimpleMessageBusDb', 'SimpleMessageBus.IndexedDb.Core.SimpleMessageBusDb', 'SimpleMessageBus.IndexedDb.Core', 'class', 'CloudNimble.BlazorEssentials.IndexedDb.IndexedDbDatabase']
---
...
```csharp
SimpleMessageBus.IndexedDb.Core.SimpleMessageBusDb
```
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> Completed
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> Failed
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> Queue
