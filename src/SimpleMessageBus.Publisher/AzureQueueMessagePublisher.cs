...
namespace CloudNimble.SimpleMessageBus.Publish
{
    ...
    /// </summary>
    /// <typeparam name="T">The type that will be handled by this publisher.</typeparam>
    public class AzureQueueMessagePublisher : IMessagePublisher
    {
        ...
        /// <summary>
        /// The <see cref="CloudQueue"/> the AQMP uses to publish to. 
        /// </summary>
        ...
        /// <param name="connectionStringName">The connection string for the Storage Account.</param>
