...
keywords: ['KafkaProcessor', 'CloudNimble.SimpleMessageBus.Dispatch.Kafka.KafkaProcessor', 'CloudNimble.SimpleMessageBus.Dispatch.Kafka', 'class', 'System.Object', 'CloudNimble.SimpleMessageBus.Dispatch.IQueueProcessor']
---
...
Creates a new instance of [KafkaProcessor](/api-reference/CloudNimble/SimpleMessageBus/Dispatch/Kafka/KafkaProcessor).
